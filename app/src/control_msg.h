...
enum sc_control_msg_type {
    ...
    SC_CONTROL_MSG_TYPE_BACK_OR_SCREEN_ON,  // 返回或进入主屏幕
    SC_CONTROL_MSG_TYPE_EXPAND_NOTIFICATION_PANEL,  // 展开通知面板
    SC_CONTROL_MSG_TYPE_EXPAND_SETTINGS_PANEL,  // 展开“设置”面板
    SC_CONTROL_MSG_TYPE_COLLAPSE_PANELS,  // 折叠面板
    SC_CONTROL_MSG_TYPE_GET_CLIPBOARD,  // 获取剪贴板
